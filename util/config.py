...
DEFAULT_CONFIG_DATA = {
    ...
    'ASPECT_RATIO_X': 29,
    'ASPECT_RATIO_Y': 64,
    'CROSSHAIR_COLOR': 'gray',
    'SHOW_LABELS': 2,
    'SHOW_DISTANCE_BARS': 1,
    'DISTANCE_BARS_SIZE': 15,
    'DISTANCE_BARS_MAXD': 2*10**6,
    'DISTANCE_BARS_CURVE': 0.3,
    ...
    'HOTKEY_COMMANDS': {
        ...
        'f1': 'gui.layout.screen 1',
        'f2': 'gui.layout.screen 2',
        'f3': 'gui.layout.screen 3',
        'f4': 'gui.layout.screen 4',
        'f5': 'gui.layout.screen 5',
        'f6': 'gui.layout.screen 6',
        'f7': 'gui.layout.screen 7',
        'f8': 'gui.layout.screen 8',
        '^ f12': 'gui.debug',
        # universe simulation
        'space': 'sim.toggle',
        '^ t': 'sim.tick 1',
